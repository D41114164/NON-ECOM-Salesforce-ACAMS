/*
Salesforce.com AJAX Connector 39.0
...
sforce.internal.Debug = function() {
    ...
    this.println = function(s, type) {
        ...
        if (this.win === null || !this.win.document) {
            this.output = null;
            this.win = window.open((typeof window.UserContext != "undefined") ? UserContext.getUrl('/soap/ajax/39.0/debugshell.html') : '/soap/ajax/39.0/debugshell.html', '',
...
sforce.Connection = function() {
    ...
    this.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/store/services/Soap/u/39.0") : "/store/services/Soap/u/39.0";
};
...
sforce.connection.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/store/services/Soap/u/39.0") : "/store/services/Soap/u/39.0";
